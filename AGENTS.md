# ElizaOS Agent Project Development Guide for Codex

> **Optimized for Codex LLM** - Complete reference for building ElizaOS agent projects

## Design Reference Files

For public-facing editorial pages, standalone guides, and one-pagers in this repo, consult these files before making visual changes:
...
- Ask clarifying questions when requests are ambiguous`,
  ...
  plugins: [
    ...
    // "@elizaos/plugin-anthropic", // Codex models
...
| `@elizaos/plugin-anthropic` | Codex 3.5 Sonnet, Haiku | Reasoning, analysis            |
